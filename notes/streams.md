...
for static bytecode verification that I mentionedd. Or you could write a single-step
debugger for the bytecode VM. Get creative and try to think up fun extensions like that.
